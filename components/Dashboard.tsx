...
const Dashboard: React.FC = () => {
  ...
  const historyOrders = orders.filter(o => o.status !== 'waiting');
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
        <div>
          ...
          <p className="text-zinc-500 mt-2">Welcome back, {user.username}. Manage your numbers here.</p>
        </div>
      ...
      <div className="mb-12">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold text-white">Current Active Numbers</h3>
          </div>
          <button
        ...
        {isLoading ? (
          ...
          <div className="bg-zinc-900/20 border border-dashed border-zinc-800 rounded-[2rem] p-10 text-center">
              <Smartphone className="w-10 h-10 text-zinc-800 mx-auto mb-3" />
              <p className="text-zinc-500 font-medium">No active numbers at the moment.</p>
              <Link to="/app" className="text-emerald-500 text-sm hover:underline mt-2 inline-block">Buy a new number →</Link>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div className="bg-zinc-900/10 border border-zinc-800/50 rounded-[2rem] p-10 text-center">
